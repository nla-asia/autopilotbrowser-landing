  ...
  const features = [
    {
      id: 1,
      title: "AI Assistant",
      description: "Your intelligent browsing companion that understands your needs and takes action automatically. From research to booking, let AI handle the heavy lifting.",
      mockup: (
          ...
          <div className="bg-white rounded-[2rem] overflow-hidden h-full">
            ...
            <div className="p-4 h-full bg-gradient-to-br from-gray-800 via-gray-900 to-black">
              <div className="text-center mb-4">
                ...
                <h3 className="text-white text-sm font-bold font-orbitron">AI Assistant</h3>
              </div>
          ...
          <div className="bg-white rounded-[2rem] overflow-hidden h-full">
            ...
            <div className="p-4 h-full bg-white">
              <div className="bg-gray-100 rounded-full px-4 py-2 mb-4 text-center">
                <div className="text-xs text-gray-600 font-orbitron">autopilotbrowser.com</div>
              </div>
              <div className="space-y-4">
                <div className="text-center">
                  <div className="text-lg font-bold text-gray-900 font-orbitron mb-2">Clean Reading</div>
                  <div className="text-xs text-gray-600 font-orbitron leading-relaxed">
                ...
                <div className="text-center">
                  <div className="text-xs text-gray-500 font-orbitron">No ads • No pop-ups • Pure content</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="p-4 h-full bg-gradient-to-br from-purple-50 via-blue-50 to-gray-50">
              ...
              <div className="space-y-3">
                <div className="bg-white rounded-xl p-3 shadow-sm border border-purple-100">
                  <div className="text-xs text-purple-600 mb-1 font-orbitron">Preference</div>
                  <div className="text-xs text-gray-800 font-orbitron">Prefers aisle seats on flights</div>
                </div>
                <div className="bg-white rounded-xl p-3 shadow-sm border border-blue-100">
                  <div className="text-xs text-blue-600 mb-1 font-orbitron">Habit</div>
                  <div className="text-xs text-gray-800 font-orbitron">Usually books hotels with gym access</div>
                </div>
                <div className="bg-white rounded-xl p-3 shadow-sm border border-green-100">
                  <div className="text-xs text-green-600 mb-1 font-orbitron">Context</div>
                  <div className="text-xs text-gray-800 font-orbitron">Works remotely, travels frequently</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <section id="features" className="py-24 relative overflow-hidden bg-black">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed font-orbitron">
          ...
          {features.map((feature, index) => (
            <div key={feature.id} className={`grid grid-cols-1 lg:grid-cols-2 gap-16 items-center ${index % 2 === 1 ? 'lg:grid-flow-dense' : ''}`}>
              ...
              <div className={`${index % 2 === 1 ? 'lg:col-start-2' : ''} text-center lg:text-left relative`}>
                ...
                <p className="text-xl text-gray-300 leading-relaxed font-orbitron max-w-lg">
                  {feature.description}
                </p>
