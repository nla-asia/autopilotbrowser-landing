  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-gray-900/20 backdrop-blur-md border-b border-white/10 shadow-2xl">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">          
          ...
          <div className="flex items-center">            
            <div className="flex-shrink-0 flex items-center space-x-3">              
              ...
              />
              <h1 className="text-2xl font-bold text-white tracking-wider uppercase font-orbitron">
                Autopilot Browser
              </h1>
            </div>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-gray-900/30 backdrop-blur-lg border-t border-white/10 rounded-b-xl">              <a
                href="#features"
              ...
              <div className="px-3 py-2">
                <button className="w-full bg-[#1D4ED8] hover:bg-[#1e40af] text-white px-6 py-2 rounded-lg text-sm font-medium transition-colors font-orbitron">
                  Get Started
                </button>
              </div>
            </div>
